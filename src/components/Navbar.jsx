...
const Navbar = () => {
  ...
  return (
    <div className="part1 w-5/6 rounded-lg flex justify-between items-center bg-[#838383] overflow-hidden px-[40px] py-2">
      ...
      <button className="px-6 py-2 rounded-[10px] font-semibold bg-[#FF6B00] border-0 outline-0">
        Enquiries
      </button>
    </div>
  );
